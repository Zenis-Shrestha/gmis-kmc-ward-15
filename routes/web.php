...
Route::middleware([])->get('buildings/add', 'BuildingController@add');
...
Route::get('yes-no/data', 'YesNoController@getData');
Route::get('yes-no/export', 'YesNoController@export');
// Replace "create" with "add"
Route::get('yes-no/add', 'YesNoController@add')->name('yes-no.add');
Route::resource('yes-no', 'YesNoController');


Route::resource('road-hierarchies', 'RoadHierarchyController');
...
/// For Point Of Intersect
    // Route::get('point-interest/export', 'POI@export');
    Route::get('point-interest/data', 'POIController@getData');
    // Route::get('point-interest/{id}/history', 'POI@history');
    Route::resource('point-interest', 'POIController');
